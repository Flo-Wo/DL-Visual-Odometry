...
Therefore we did not expect our models to perform really well using the initial splitting, as the they are trained and tested with totally different road traffic scenarios.
...
For our data set, we used the \enquote{comma ai speedchallenge} data base. This data
