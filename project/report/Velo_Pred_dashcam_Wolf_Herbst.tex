...
Using the initial model on the training data with a hard splitting, we achieved a MSE of 18-20 in the 
validation set, while having a MSE of less than 3 on the training set. The initial network therefore has 
some clear overfitting problems, which we tried to address with our fine tuning.
