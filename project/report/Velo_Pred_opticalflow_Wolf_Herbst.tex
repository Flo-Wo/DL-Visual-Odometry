...
\title{Predicting a cars velocity using dashcam footage and dense optical flow}
...
For our data base, we used the comma ai speedchallenge\footnote{https://github.com/commaai/speedchallenge} data set. This data
base provides two dashcam videos: a trainings video, (20400 frames, shoot at 20 frames per second) including 
