...
\begin{frame}{Analysis of the dataset}
	...
	\begin{columns}[t]
		\begin{column}{.45\textwidth}
			\begin{center}
				\only<1->{\includegraphics[width=\linewidth]{./imgs/frame2_evaluated.png}
				\small{Original frame}}
			\end{center}
		\end{column}
		\begin{column}{.45\textwidth}
			\begin{center}
				\only<3->{\includegraphics[width=\linewidth]{./imgs/frame2_cut_sampled.png}
...
%				\end{itemize}
		...
		\begin{column}{.45\textwidth}
			\begin{center}
				\only<1->{\includegraphics[width=0.85\textwidth, height=0.34\textheight]{./imgs/plot_speed_time_new_splitting.eps}
				{\footnotesize driving situations in v-t-plot}}
				\only<2->{\includegraphics[width=0.85\textwidth]{./imgs/example_performance.png}
