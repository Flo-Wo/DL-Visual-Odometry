...
class CnnFramesOfConv(nn.Module):
    def __init__(self, last_layer=False):
        # call super method to create instance of the network class
        super(CnnFramesOfConv, self).__init__()

        self.conv1 = conv_layer(9, 16, kernel_size=5, padding=3, stride=2)
        self.conv2 = conv_layer(16, 16, kernel_size=4, padding=2, stride=2)
        self.conv3 = conv_layer(16, 16, kernel_size=4, padding=2, stride=2)
