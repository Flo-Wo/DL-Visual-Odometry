...
from data_loader import generate_block_splitting, generate_label_dict, path_labels, \
    generate_situation_splitting, DatasetFrames, generate_test_splitting, path_labels_test, DatasetOptFlo2Frames
...
net_name = "LeakyReLU_FramesOfCONV_SitSplit"
...
if __name__ == "__main__":
    ...
    train_tensor, validation_tensor, test_tensor = setup_data_loader(DatasetOptFlo2Frames, splitting, labels,
