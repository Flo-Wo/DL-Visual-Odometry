...
if __name__ == "__main__":
    ...
    #splitting = generate_situation_splitting(0.8,augmentation=True)
    ...
    train_network(train_tensor, validation_tensor, 15, "LeakyReLU_Frames_Conv_100Split_20Epochs_BatchNorm_MaxPool_AUGMENTED",
