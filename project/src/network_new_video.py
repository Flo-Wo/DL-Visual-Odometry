...
txt6 = np.genfromtxt("./cnn/saved_models/SuperSuperSimple_NoOffset_test.txt")
...
plt.plot(txt1_convolved, color="gray", ls="--", label="Normal Smoothed (SitSplitShuffle)", zorder=1)
