...
def train_model(train_dataset, eval_dataset,num_input_channels, num_epochs, log_filename):
    ...
    torch.save(model.state_dict(),"./cnn/savedmodels/LeakyReLU8EpochsBatchNormMaxPoolingWithDropOut.pth")
    print("model saved!")
...
if __name__ == "__main__":
    ...
    train_model(train_tensor, eval_tensor, 3, 8, "LeakyReLU8EpochsBatchNormMaxPoolingWithDropOut")
